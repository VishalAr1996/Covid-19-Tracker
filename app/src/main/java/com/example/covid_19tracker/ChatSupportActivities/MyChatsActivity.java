...
import com.example.covid_19tracker.databinding.ActivityMychatsBinding;
...
public class MyChatsActivity extends AppCompatActivity {
  ActivityMychatsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("My Chats");
        binding.myChatsRecyclerView.setHasFixedSize(true);
        binding.myChatsRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mAuth=FirebaseAuth.getInstance();
        reference= FirebaseDatabase.getInstance().getReference().child("Friends");
        loadAllChats("");
    }

    private void loadAllChats(String s) {
        ...
        adapter=new FirebaseRecyclerAdapter<Users, AllFriendsViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull @NotNull AllFriendsViewHolder holder, int position, @NonNull @NotNull Users model) {
                ...
                holder.itemView.setOnClickListener(v -> {
                    Intent intent=new Intent(MyChatsActivity.this,ChattingActivity.class);
...
//
        ...
        binding.myChatsRecyclerView.setAdapter(adapter);
    }
    @Override
